...
const ROLE_GRADIENT: Record<IdeaAttributes["role"], string> = {
  spark:
    "radial-gradient(circle at 30% 30%, rgba(255,255,255,0.85), rgba(255,215,160,0.55) 35%, rgba(255,180,120,0.15) 70%)",
  plan:
    "radial-gradient(circle at 30% 30%, rgba(255,255,255,0.82), rgba(170,210,255,0.55) 35%, rgba(120,170,255,0.15) 70%)",
  grow:
    "radial-gradient(circle at 30% 30%, rgba(255,255,255,0.82), rgba(170,255,215,0.52) 35%, rgba(90,220,150,0.16) 70%)",
};
  ...
  return (
    ...
    >
      <motion.div
        ...
        animate={{
          scale: [
            ENERGY_SCALE[attributes.energy],
            ENERGY_SCALE[attributes.energy] * 1.06,
            ENERGY_SCALE[attributes.energy],
          ],
      ...
      <motion.div
        className="relative h-[120px] w-[120px] rounded-full border border-white/35 backdrop-blur-sm"
        style={{ background: ROLE_GRADIENT[attributes.role] }}
        animate={{
          scale: [
            ENERGY_SCALE[attributes.energy],
            ENERGY_SCALE[attributes.energy] * 1.03,
            ENERGY_SCALE[attributes.energy],
          ],
          boxShadow: [
